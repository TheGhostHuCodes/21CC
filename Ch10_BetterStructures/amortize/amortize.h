/** \file amortize.h
 *  \brief This is a file declares functions in a file that does math.
 */
 ...
 *
 *  \li \c amt The dollar value of the loan. No default--if unspecified, print
 *  an error and return zeros.
 *  \li \c months The number of months in the loan. Default: zero, but see
 *  years.
 ...
 *  mortgage).
 *  \li \c rate The interest rate of the loan, expressed in annual percentage
 ...
 *  the present value of money. Default:0, meaning no present-value adjustment.
 *  A rate of about 3 has been typical for the last few decates in the US.
 ...
 *  \li \c interest_pv Total interest paid, with present-value adjusted for
 *  inflation.
 *  \li \c monthly_payment The fixed monthly payment (for a mortgage, taxes and
 *  interest get added to this)
 *  \li \c years_to_payoff Normally the duration or selloff date, but if you
 *  make early payments, the loan is paid off sooner.
 *  \li \c error If <tt>error != NULL</tt>, something went wrong and the
 *  results are invalid.
 */
