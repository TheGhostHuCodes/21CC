/** \file amort_use.c
 *  \brief This file uses the amortize method to do some math.
 */
#include "amortize.h"
#include <stdio.h>
...
int main() {
    ...
    amortization_s a_hundred
        = amortization(.amount = 200000, .inflation = 3, .show_table = 0,
                       .extra_payoff = 100);
    printf("Paying an extra $100/month, you loose only $%g (PV), and the loan "
           "is paid off in %g years.\n",
